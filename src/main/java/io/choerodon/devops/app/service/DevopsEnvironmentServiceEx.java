 ...
 */
public interface DevopsEnvironmentServiceEx {
    /**
     * 项目下创建环境
     *
     ...
     * @return List
     */
    List<DevopsEnvGroupEnvsWithQuotaDTO> listDevopsEnvGroupEnvs(Long projectId, Boolean active);
     ...
     * @return List
     */
    List<DevopsEnviromentRepWithQuotaDTO> listByProjectIdAndActive(Long projectId, Boolean active);
